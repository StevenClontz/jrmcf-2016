...
{\Large
\noindent Partner up and follow the instructions below with the template provided:
\begin{enumerate}
...
\end{enumerate}
You and your partner should have $6$ of the same shape each one is called a Sonobe unit. With the following instructions construct a cube from your $6$ Sonobe units:
\begin{enumerate}
